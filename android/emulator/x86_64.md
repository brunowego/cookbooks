...
# Install packages
sdkmanager --install "platform-tools" "platforms;android-35" "system-images;android-35;google_apis_playstore;x86_64"
```
...
```sh
#
sed -ri '/PlayStore.enabled/ s/no/yes/' ~/.android/avd/Pixel_4_API_35.avd/config.ini
```

<!--
Change /google_apis/ to /google_apis_playstore/
-->
